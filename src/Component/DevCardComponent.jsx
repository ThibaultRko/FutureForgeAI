...
function DevCardComponent({image, alt, job, name, location, text, link1, link2}) {
    return(
        <div>
            <div className="relative max-w-md mx-auto md:max-w-2xl mt-6 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-16 bg-borderAndSeparator1">
                <div className="px-6">
                    ...
                    <div className="text-center mt-2">
                        ...
                        <div className="text-xs mt-0 mb-2 text-textColor1 font-bold uppercase">
                            <i className="fas fa-map-marker-alt mr-2 5 text-textColor1"></i>{location}
                        </div>
                    </div>
                    <div className="mt-6 py-6 border-t border-slate-200 text-center">
                        <div className="flex flex-wrap justify-center">
                            <div className="w-full px-4">
                                <p className="leading-relaxed mb-4 font-medium text-textColor1">{text}</p>
